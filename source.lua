--[[
    ...
    -- Creditos a Todos Programadores Pois Usei Isso como Teste, Desculpa por Copiar e Vlws por Fazer esse GUI Foda Pra Caralho
]]

if debugX then
	warn('Initialising DSS Hub')
end
...
function RayfieldLibrary:CreateWindow(Settings)
	...
	if Settings.LoadingTitle ~= "DSS Interface Suite" then
		LoadingFrame.Version.Text = "DSS UI"
	end
	...
	if Settings.Icon and Settings.Icon ~= 0 and Topbar:FindFirstChild('Icon') then
		...
		if Settings.Icon then
			if typeof(Settings.Icon) == 'string' and Icons then
				...
				Topbar.Icon.Image = 'rbxassetid://102036336381325'
